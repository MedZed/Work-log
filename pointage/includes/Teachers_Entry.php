...
$sql_ins=mysqli_query($con, "INSERT INTO teacher_tbl VALUES( NULL,'$f_name','$l_name' ,'$gender','$dob','$addr','$degree','$salary' ,'$married','$phone','$mail')");
if($sql_ins==true) {
    $msg = ucfirst($f_name) ;
    echo "<div>"
            ...
            <form role="form" data-toggle="validator" method="post" class="form-horizontal">
                <div class="row">
                    <div class="form-group">
                        <label for="fnametxt" class="control-label col-sm-3">Nom :</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="fnametxt" name="fnametxt" value="<?php echo $rs_upd['f_name'];?>"/>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="lnametxt" class="control-label col-sm-3"> Prénom:</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="lnametxt" name="lnametxt" value="<?php echo $rs_upd['l_name'];?>"/>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="gender" class="control-label col-sm-3">Genre:</label>
                        <div class="radio col-sm-2">
                            <label><input type="radio" name="gender" value="male" <?php if($rs_upd['gender']=="male") echo "checked";?>>Homme</label>
                        </div>
                        <div class="radio col-sm-4">
                            <label><input type="radio" name="gender" value="female" <?php if($rs_upd['gender']=="female") echo "checked";?>>Femme</label>
                        </div>
                    </div>
                    <div class="form-group">
                    <label for="marriedrdo" class="control-label col-sm-3">Marié:</label>
                    <div class="radio col-sm-2">
                        <label><input type="radio" name="marriedrdo" value="male" <?php if($rs_upd['gender']=="male") echo "checked";?>>Oui</label>
                    </div>
                    <div class="radio col-sm-4">
                        <label><input type="radio" name="marriedrdo" value="female" <?php if($rs_upd['gender']=="female") echo "checked";?>>Non</label>
                    </div>
                </div>
                    <div class="form-group">
                        <label for="phonetxt" class="control-label col-sm-3">Téléphone:</label>
                        <div class="col-sm-8">
                    ...
                    <div class="form-group">
                        <label for="slarytxt" class="control-label col-sm-3">Salaire:</label>
                        <div class="col-sm-8">
                            <input type="number" class="form-control only-number" id="slarytxt" name="slarytxt" value="<?php echo $rs_upd['salary'];?>">
                        </div>
                    </div>
                    <div class="form-group">
                    <label for="degree" class="control-label col-sm-3">Niveau:</label>
                    <div class="col-sm-8">
                        <select class="form-control" name="degree">
                            <option <?php if($rs_upd['degree']=="Bachelor") echo "selected";?>>Bachelier</option>
                    ...
                    <div class="form-group">
                        <label for="dob" class="control-label col-sm-3">Date de naissance :</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control datepicker" name="dob" value="<?php echo $rs_upd['dob'];?>" data-date-format="yyyy-mm-dd"/>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="addrtxt" class="control-label col-sm-3">Addresse:</label>
                        <div class="col-sm-8">
...
<div class="col-md-10 col-md-offset-1 form-style">
    <div class="col-md-12 entry-head margin-20b">
        <h4 class="left">Entrer Enseignant</h4>
        <a class="btn btn-primary right" href="?tag=view_teachers">Voir Enseignant</a>
    </div>
    <div class="col-md-10 col-md-offset-1">
        <form role="form" data-toggle="validator" method="post" class="form-horizontal">
            <div class="row">
                ...
                <div class="form-group">
                    <label for="genderrdo" class="control-label col-sm-3">Genre:</label>
                    <div class="radio col-sm-2">
                        <label><input type="radio" name="genderrdo" value="male" required>Homme</label>
                    </div>
                    <div class="radio col-sm-4">
                        <label><input type="radio" name="genderrdo" value="female" required>Femme</label>
                    </div>
                </div>
                <div class="form-group">
                    <label for="marriedrdo" class="control-label col-sm-3">Marrié:</label>
                    <div class="radio col-sm-2">
                        <label><input type="radio" name="marriedrdo" value="yes" required>Oui</label>
                    </div>
                    <div class="radio col-sm-4">
                        <label><input type="radio" name="marriedrdo" value="no" required>Non</label>
                    </div>
                </div>
                <div class="form-group">
                    <label for="phonetxt" class="control-label col-sm-3">Téléphone:</label>
