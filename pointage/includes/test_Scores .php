...
<div id="content-input">
    ...
    ?>
      <tr bgcolor="<?php echo $color?>">
            ...
            <td align="center"><a href="?tag=score_entry&opr=upd&rs_id=<?php echo $row['ss_id'];?>"><i class="fas fa-pen-square"></i></a></td>
            <td align="center"><a href="?opr=del&rs_id=<?php echo $row['ss_id'];?>"><i class="fas fa-minus-square"></i></a></td>
        </tr>
