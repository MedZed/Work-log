...
<div class="table-responsive">
    ...
    ?>
      <tr bgcolor="<?php echo $color?>">
            ...
            <td><a href="?tag=teachers_entry&opr=upd&rs_id=<?php echo $row['teacher_id'];?>" title="Upate"><i class="fas fa-pen-square"></i></a></td>
            <td><a href="?tag=view_teachers&opr=del&rs_id=<?php echo $row['teacher_id'];?>" title="Delete" class="delete-btn" data-title="Êtes-vous sûr de vouloir supprimer ceci ?"><i class="fas fa-minus-square"></i></a></td>
        </tr>
    <?php	
    }
    ?>
